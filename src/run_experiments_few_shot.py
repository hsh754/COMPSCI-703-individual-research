...
def print_summary(all_results, model_name, sample_size):
    ...
    for script in ['main_csqa_fewshot.py', 'main_cose_fewshot.py']:
        dataset = "CommonsenseQA" if script == "main_csqa_fewshot.py" else "CoS-E"
        for prompt_type in ['templated', 'natural']:
...
def run_sequential(model_name, sample_size):
    ...
    experiments = [
        ("main_csqa_fewshot.py", "templated"),
        ("main_csqa_fewshot.py", "natural"),
        ("main_cose_fewshot.py", "templated"),
        ("main_cose_fewshot.py", "natural")
    ]
...
def get_script_by_dataset(dataset):
    ...
    if dataset.lower() in ['commonsenseqa', 'csqa']:
        return 'main_csqa_fewshot.py'
    elif dataset.lower() in ['cose', 'cos-e']:
        return 'main_cose_fewshot.py'
    else:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run few-shot experiment scripts")
    parser.add_argument(
        "--mode",
